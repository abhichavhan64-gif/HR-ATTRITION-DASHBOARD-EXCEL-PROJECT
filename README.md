...
An interactive Excel dashboard for analyzing employee attrition, demographics, education, department-wise trends, and workforce insights.
...
The **HR Attrition Analysis Dashboard** is an interactive Microsoft Excel project designed to analyze employee attrition data and identify important patterns related to department, gender, education, age group, marital status, and employee demographics.

This dashboard helps HR teams understand why employees leave the organization and supports better workforce planning and employee retention decisions.

> 💡 **Goal:** Convert employee data into meaningful insights for improving employee retention.
...
### 3️⃣ Education-wise Attrition

Displays attrition based on employee education background.

This helps identify education categories with higher employee turnover.
...
<img src="Dashboard_Screenshot.png" width="100%" alt="HR Attrition Analysis Dashboard">
